...
#########################################################
pdf('/work/smodi/crohn/changeo/pdf/newpanel5.pdf',width=8.5,height=5.5)
layout(rbind(c(1,1,1,2),c(3,3,3,4)))
par(mar=c(6,5,2,2),cex=0.6)
...
axis(side = 1,at = (0:63)*2.5+1.5,labels=substr(colnames(z)[1:64],2,4),lwd.ticks = T,las=2,cex.axis=0.9)
